                ...
                <form action="crew_schedule_write.do" method="post">
                        ...
                        <div class="btn_flex">
                            ...
                            <div class="width50p">
                             <h5 class="capt">운동 시작 시간</h5>
                                <input class="narrow" type="time" id="start-time" name="start-time" required>
                            </div>
                            
                            <div class="width50p">
                            <h5 class="capt">운동 종료 시간</h5>
                                <input class="narrow" type="time" id="end-time" name="end-time" required>
                            </div>
                        </div>
                    </div>
                    <!-- //둘로 나뉜 셀렉트박스 / 버튼 -->
                    ...
                    <div class="list">
                        ...
                        <!-- flex-narrow 박스 설정 -->
                        	...
                        	<!-- 너비 설정 -->
                          <p> <textarea id="place" maxlength="1000" class="full pass" name="place" /></textarea></p>
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9a522c7744ff77d8193b972f95c556a1"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
