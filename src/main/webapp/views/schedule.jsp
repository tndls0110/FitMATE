                ...
                <div class = "crew_schedule">
                    ...
                    <div class="crew_schedule_content">
                       ...
                       <div class="crew_schedule_content_detail">
                            <div class="circle">●</div>&nbsp;&nbsp;&nbsp;<div class="crew_name">${crew_name}</div> &nbsp;&nbsp;&nbsp;
                            <div class="crew_schedule_text">${모임장소}에서 하체 운동</div>
                        </div>
                    </div>
                </div>
                ...
                <div class = "journal">
                    <div class="journal_content">
                        <div class="journal_datetime">
                            <div class="journal_date">2024-10-14</div> &nbsp;&nbsp;&nbsp; <!--<div class="journal_time">09:20</div>-->  
                            <div class="journal_start_end">
                                <div class="crew_tag">크루</div>&nbsp;&nbsp;&nbsp;<div class="journal_start">시작 시간</div>  &nbsp;&nbsp;&nbsp; <div class="journal_end">끝난 시간</div>
                            </div>
                        </div>    
                        <div class="journal_text">내 그대를 생각함은 항상 그대가 앉아 있는 배경에서 해가 지고 바람이 부는 일처럼 사소한 일일 것이나</div>
                ...
                <div class = "journal">
                    <div class="journal_content">
                        <div class="journal_datetime">
                            <div class="journal_date">2024-10-14</div> &nbsp;&nbsp;&nbsp; <!--<div class="journal_time">09:20</div>-->
                            <div class="journal_start_end">
                                <div class="individual_tag">개인</div> &nbsp;&nbsp;&nbsp; <div class="journal_start">시작 시간</div>  &nbsp;&nbsp;&nbsp; <div class="journal_end">끝난 시간</div>
                            </div>
                        </div>    
                        <div class="journal_text">내 그대를 생각함은 항상 그대가 앉아 있는 배경에서 해가 지고 바람이 부는 일처럼 사소한 일일 것이나</div>
