                    ...
                    <li>
                        <form id="${list.regions_idx}" action="admin_updateRegion_sub.do" method="post">
                            <div class="btn_flex narrow">
                                ...
                                <div class="width80p">
                                    <input type="text" name="regions_name" value="${list.regions_name}" class="full flex_left" onblur="regData('update', ${list.regions_idx})" />
                                </div>
                                <div class="width20p">
                                    <input type="button" value="삭제" class="subbtn full flex_right" onclick="regData('delete', ${list.regions_idx})" />
                                </div>
                            </div>
                        </form>
                    </li>
